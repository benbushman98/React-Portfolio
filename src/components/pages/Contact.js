        ...
        <div>
            <div className="container my-5">
                <div className="row">
                    ...
                    <div className="col-6 text-center bg-light">
                        <h1>Contact Me</h1>
                    </div>
                    <div className="col">
                    </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className='col-6 text-center m-5 p-2'>
                        <p className='d-flex bg-light py-3 px-1'>Please reach out to me with any questions, concerns, suggestions, or interest in collaboration. Feel free to reach out to me via the contact form or visit me on social media.</p>
