...
const Footer = () => {
  ...
  return (
    <footer style={style.footer} className="text-center w-100 py-3 mt-4">
      <div className='container'>
        <br />
        <div className='bg-white d-inline-flex m-2 rounded-pill'>
          <div className='d-flex'>
            <div className='ms-3' style={style.social}><a style={style.link} href="https://github.com/benbushman98" target="_blank" rel="noopener noreferrer" alt="GitHub Profile"><i aria-hidden="true" className="fa fa-1x fa-github"></i><title>GitHub</title></a></div>
            <div className='' style={style.social}><a style={style.link} href="https://www.linkedin.com/in/benjamin-bushman/" target="_blank" rel="noopener noreferrer" alt="LinkedIn Profile"><i aria-hidden="true" className="fa fa-1x fa-linkedin"></i><title>LinkedIn</title></a></div>
        ...
        <p className='mt-2 text-white'>Created and Designed by Benjamin Bushman | Copyright © 2023</p>
      </div>
    </footer>
  )
}
